...
public class HomePageTest extends BaseClass {
	...
	public void brokenURLHomepage_TC102_to_TC103() {
		 ...
		 @Test(description = "Verify user can search product and add to cart.", priority = 2, 
				 groups = {"Smoke", "Sanity"})
		 public void searchAddItemsCart_TC111() {
		 ...
		 @Test(priority = 3, description = "Verify user is able to fetch the orderstatus", groups = "jenkins")
		 public void orderStatusValidation() {
			 
			 //Text to validate
			 String mainHeader = "Order Status";
			 String notification = "Hi there! Looking\nfor a current order?";
			 
			 home = new HomePage(driver);
			 home.clickOrderStatus();
			 boolean isCheckOrderIconDisplayed = home.isMainHeaderDisplayed();
			 
			 boolean isMainHeaderValid = home.isMainHeaderValid(mainHeader);	
			 
			 String actual = home.orderStatusMessageValidate(notification);
			 System.out.println(actual);	
			 
			 System.out.println(isCheckOrderIconDisplayed);
			 System.out.println(isMainHeaderValid);
